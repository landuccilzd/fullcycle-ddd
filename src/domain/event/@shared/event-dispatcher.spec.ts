...
import AddressChangedEvent from "../customer/address-chaged.event";
import CustomerCreatedEvent from "../customer/customer-created.event";
import WriteToLogWhenAddressIsChanged from "../customer/handler/write-to-log-when-address-is-changed.handler copy";
import WriteToLog1WhenCustomerIsCreatedHandler from "../customer/handler/write-to-log1-when-customer-is-created.handler";
import WriteToLog2WhenCustomerIsCreatedHandler from "../customer/handler/write-to-log2-when-customer-is-created.handler";
